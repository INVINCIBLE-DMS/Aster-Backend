...
public class StudentService {
    ...
    public void studentName() {
        ...
        //1-1반
        studentList.add(new Student("1412", "권민휘"));
        studentList.add(new Student("1412", "김가은"));
        studentList.add(new Student("1412", "김강민"));
        studentList.add(new Student("1412", "김명진"));
        studentList.add(new Student("1412", "김현성"));
        studentList.add(new Student("1412", "김희찬"));
        studentList.add(new Student("1412", "박재민"));
        studentList.add(new Student("1412", "부현수"));
        studentList.add(new Student("1412", "오송주"));
        studentList.add(new Student("1412", "오현규"));
        studentList.add(new Student("1412", "유하은"));
        studentList.add(new Student("1412", "이지후"));
        studentList.add(new Student("1412", "이태윤"));
        studentList.add(new Student("1412", "이하윤"));
        studentList.add(new Student("1412", "조영준"));
        studentList.add(new Student("1412", "홍서은"));

// 1-2반
        studentList.add(new Student("1412", "강태양"));
        studentList.add(new Student("1412", "김호선"));
        studentList.add(new Student("1412", "노승준"));
        studentList.add(new Student("1412", "박예빈"));
        studentList.add(new Student("1412", "서동빈"));
        studentList.add(new Student("1412", "안승민"));
        studentList.add(new Student("1412", "양윤호"));
        studentList.add(new Student("1412", "유지우"));
        studentList.add(new Student("1412", "이강희"));
        studentList.add(new Student("1412", "이금규"));
        studentList.add(new Student("1412", "이의진"));
        studentList.add(new Student("1412", "이태규"));
        studentList.add(new Student("1412", "차은비"));
        studentList.add(new Student("1412", "최유준"));
        studentList.add(new Student("1412", "최희영"));
        studentList.add(new Student("1412", "한건희"));

// 1-3반
        studentList.add(new Student("1412", "강현욱"));
        studentList.add(new Student("1412", "김민재"));
        studentList.add(new Student("1412", "김시열"));
        studentList.add(new Student("1412", "김효정"));
        studentList.add(new Student("1412", "남궁윤교"));
        studentList.add(new Student("1412", "박의엘"));
        studentList.add(new Student("1412", "서예린"));
        studentList.add(new Student("1412", "오재영"));
        studentList.add(new Student("1412", "원은지"));
        studentList.add(new Student("1412", "유연준"));
        studentList.add(new Student("1412", "육기준"));
        studentList.add(new Student("1412", "이나경"));
        studentList.add(new Student("1412", "이은성"));
        studentList.add(new Student("1412", "이은호"));
        studentList.add(new Student("1412", "임다영"));
        studentList.add(new Student("1412", "조현민"));

// 1-4반
        studentList.add(new Student("1412", "강해민"));
        studentList.add(new Student("1412", "고은총"));
        studentList.add(new Student("1412", "김대운"));
        studentList.add(new Student("1412", "김도경"));
        studentList.add(new Student("1412", "김승원"));
        studentList.add(new Student("1412", "김어진"));
        studentList.add(new Student("1412", "김준화"));
        studentList.add(new Student("1412", "박수현"));
        studentList.add(new Student("1412", "박지민"));
        studentList.add(new Student("1412", "박현아"));
        studentList.add(new Student("1412", "백승휘"));
        studentList.add(new Student("1412", "변정현"));
        studentList.add(new Student("1412", "이영하"));
        studentList.add(new Student("1412", "이재영"));
        studentList.add(new Student("1412", "이태영"));
        studentList.add(new Student("1412", "최은빈"));
