...
public class QFeed extends EntityPathBase<Feed> {
    ...
    private static final long serialVersionUID = 1766490091L;
    ...
    public final com.example.asterbackend.domain.user.entity.QUser user;
    ...
    public QFeed(Class<? extends Feed> type, PathMetadata metadata, PathInits inits) {
        ...
        this.user = inits.isInitialized("user") ? new com.example.asterbackend.domain.user.entity.QUser(forProperty("user")) : null;
    }
